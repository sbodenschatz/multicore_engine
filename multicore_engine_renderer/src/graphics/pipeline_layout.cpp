...
pipeline_layout::pipeline_layout(
	...
	std::transform(
			descriptor_set_layouts_.begin(), descriptor_set_layouts_.end(), std::back_inserter(dsls),
			[](const std::shared_ptr<const descriptor_set_layout>& dsl) { return dsl->native_layout(); });
