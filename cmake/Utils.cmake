...
function(make_src_groups)
	file(GLOB src_dirs RELATIVE ${CMAKE_CURRENT_SOURCE_DIR}/include/mce "include/mce/*" "include/mce/*/*" "include/mce/*/*/*" "include/mce/*/*/*/*")
	...
	foreach(src_dir ${src_dirs})
		if(IS_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/src/${src_dir} OR IS_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/include/mce/${src_dir})
			string(REPLACE / \\ src_grp ${src_dir})
			source_group(${src_grp} REGULAR_EXPRESSION "(src/${src_dir}|include/mce/${src_dir})/.*")
		endif()
	endforeach()
endfunction()
