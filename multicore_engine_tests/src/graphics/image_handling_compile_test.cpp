...
static void test_image_handling_compilation() {
	...
	mce::graphics::image_1d img2(dev, mm, &dqm, vk::Format::eA8B8G8R8UnormPack32, 1024,
								 vk::ImageUsageFlagBits::eSampled, vk::ImageLayout::eShaderReadOnlyOptimal);
	auto iv2 = img2.create_view();
	mce::graphics::image_3d img3(dev, mm, &dqm, vk::Format::eA8B8G8R8UnormPack32, {1024, 1024, 1024},
								 vk::ImageUsageFlagBits::eSampled, vk::ImageLayout::eShaderReadOnlyOptimal);
	auto iv3 = img3.create_view();

	mce::graphics::image_2d_layered img4(dev, mm, &dqm, vk::Format::eA8B8G8R8UnormPack32, {1024, 1024},
