...
struct containers_dual_container_map_stdvec_test : public ::testing::Test {
	typedef int key_element;
	typedef std::string value_element;
	template <typename T>
	...
	mce::containers::dual_container_map<container, key_element, value_element> dcm;
	std::map<key_element, value_element> stdmap;
	containers_dual_container_map_stdvec_test() {}
	~containers_dual_container_map_stdvec_test() {}
};

struct containers_dual_container_multimap_stdvec_test : public ::testing::Test {
	typedef int key_element;
	typedef std::string value_element;
	template <typename T>
	using container = std::vector<T>;
	mce::containers::dual_container_multimap<container, key_element, value_element> dcm;
	std::multimap<key_element, value_element> stdmap;
	containers_dual_container_multimap_stdvec_test() {}
	~containers_dual_container_multimap_stdvec_test() {}
};
...
TEST_F(containers_dual_container_map_stdvec_test, insert) {
	dcm.insert(123, "ABCD");
	stdmap.emplace(123, "ABCD");
	dcm.insert(456, "XYZ");
	stdmap.emplace(456, "XYZ");
...
TEST_F(containers_dual_container_map_stdvec_test, insert_duplicate) {
	dcm.insert(123, "ABCD");
	stdmap.emplace(123, "ABCD");
	dcm.insert(123, "EFG");
	stdmap.emplace(123, "EFG");
...
TEST_F(containers_dual_container_map_stdvec_test, insert_or_assign_duplicate) {
	dcm.insert_or_assign(123, "ABCD");
	stdmap.emplace(123, "ABCD");
	dcm.insert_or_assign(123, "EFG");
	stdmap[123] = "EFG";
...
TEST_F(containers_dual_container_map_stdvec_test, erase) {
	dcm.insert(123, "ABCD");
	stdmap.emplace(123, "ABCD");
	dcm.insert(456, "XYZ");
	stdmap.emplace(456, "XYZ");
...
TEST_F(containers_dual_container_multimap_stdvec_test, insert) {
	dcm.insert(123, "ABCD");
	stdmap.emplace(123, "ABCD");
	dcm.insert(456, "XYZ");
	stdmap.emplace(456, "XYZ");
...
TEST_F(containers_dual_container_multimap_stdvec_test, insert_duplicate) {
	dcm.insert(123, "ABCD");
	stdmap.emplace(123, "ABCD");
	dcm.insert(123, "EFG");
	stdmap.emplace(123, "EFG");
...
TEST_F(containers_dual_container_multimap_stdvec_test, erase) {
	dcm.insert(123, "ABCD");
	stdmap.emplace(123, "ABCD");
	dcm.insert(456, "XYZ");
	stdmap.emplace(456, "XYZ");
